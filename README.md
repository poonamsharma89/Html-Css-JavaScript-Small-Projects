 <h1 style="background-color:rgb(187, 26, 232); color: white; font-weight: bold; padding: 10px 20px; border-radius: 5px; text-decoration: none;">HTML CSS JavaScript Projects</h1>
